...
As of 05/19/2024 a barebone Flask app using Flask, Bootstrap (v5.3.0) and jQuery (v3.6.3) will be installed.
...
Project Link: [thaychansy/python-challenge](https://github.com/thaychansy/python-challenge)
...
* [Stack Overflow] [Python Looping thorugh CSV files and thier columns - Stack Overflow](https://stackoverflow.com/questions/45947887/python-looping-through-csv-files-and-their-columns)
